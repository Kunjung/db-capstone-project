...
-- Sat 17 Feb 2024 05:46:20 PM +0545
...
-- -----------------------------------------------------
-- Table `LittleLemonDB`.`MenusItems`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LittleLemonDB`.`MenusItems` (
  `id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `LittleLemonDB`.`Menus` (
  ...
  PRIMARY KEY (`menu_id`),
  INDEX `fk_Menus_1_idx` (`menu_item_id` ASC) VISIBLE,
  CONSTRAINT `fk_Menus_1`
    FOREIGN KEY (`menu_item_id`)
    REFERENCES `LittleLemonDB`.`MenusItems` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
